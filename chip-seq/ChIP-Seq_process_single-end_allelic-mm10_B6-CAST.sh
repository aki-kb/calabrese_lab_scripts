...
do
	...
	jid6=$(sbatch --dependency=afterok:$jid3 --time=08:00:00 --mem=2G -J ${file}.wiggle -o reports/${file}.%j.wiggle.out -e reports/${file}.%j.wiggle.err --wrap="perl ${assets}/bigsam_to_wig_mm10_wcigar4.pl sam_files/${file}_mm10_q30.sam ${assets}/mm10.chr.sizes wiggles/${file}_mm10 purple y n 50")
